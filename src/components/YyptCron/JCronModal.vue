        ...
        <el-tab-pane key="1" type="card">
          ...
          <el-radio-group v-model="result.second.cronEvery">
            ...
            <el-row>
              ...
              <el-select style="width:354px;"  multiple  v-model="result.second.specificSpecific">
                <el-option v-for="(val,index) in 60" :label="index" :key='"second"+index' :value="index" >{{ index }}</el-option>
              </el-select>
            </el-row>
            ...
            <el-radio-group v-model="result.minute.cronEvery">
              ...
              <el-row>
                ...
                <el-select style="width:340px;" size="small" multiple   v-model="result.minute.specificSpecific">
                  <el-option v-for="(val,index) in Array(60)" :key="index" :label="index" :value="index"> {{ index }}</el-option>
                </el-select>
              </el-row>
        ...
        <el-tab-pane key="3">
          ...
          <div class="tabBody">
            <el-radio-group v-model="result.hour.cronEvery">
              ...
              <el-row>
                <el-radio class="long" value="3">具体小时数(可多选)</el-radio>
                <el-select style="width:340px;" size="small" multiple    v-model="result.hour.specificSpecific">
                  <el-option v-for="(val,index) in Array(24)" :label="index" :key="index" :value="index" >{{ index }}</el-option>
                </el-select>
              </el-row>

              <el-row>
                <el-radio value="4">周期从
        ...
        <el-tab-pane key="4">
          ...
          <div class="tabBody">
            <el-radio-group v-model="result.day.cronEvery">
              ...
              <el-row>
                <el-radio label="2">每隔
                  ...
                  <el-select size="small" v-model="result.week.incrementStart">
                    <el-option v-for="(val,index) in Array(7)" :key="index" :label="index+1" :value="index+1">{{ weekDays[index] }}</el-option>
                  </el-select>
                  开始
                </el-radio>
              </el-row>
              ...
              <el-row>
                <el-radio class="long" label="4">具体星期几(可多选)</el-radio>
              ...
              <el-row>
                <el-radio class="long" label="5">具体天数(可多选)</el-radio>
                <el-select style="width:354px;" size="small" multiple    v-model="result.day.specificSpecific">
                  <el-option v-for="(val,index) in Array(31)" :key="index" :label="index+1" :value="index+1">{{ index+1 }}</el-option>
                </el-select>
              </el-row>
              ...
              <el-row>
                <el-radio label="10">最近的工作日（周一至周五）至本月
              ...
              <el-row>
                <el-radio label="11">在这个月的第
                  ...
                  <el-select size="small" v-model="result.week.cronNthDayDay">
                    <el-option v-for="(val,index) in Array(7)" :label="index+1" :key="index" :value="index+1">{{ weekDays[index] }}</el-option>
                  </el-select>
        ...
        <el-tab-pane key="5">
          ...
          <div class="tabBody">
            <el-radio-group v-model="result.month.cronEvery">
              ...
              <el-row>
                <el-radio class="long" label="3">具体月数(可多选)</el-radio>
                <el-select style="width:354px;" size="small" filterable multiple  clearable  v-model="result.month.specificSpecific">
                  <el-option v-for="(val,index) in Array(12)" :label="index+1" :key="index" :value="index+1">{{ index+1 }}</el-option>
                </el-select>
              </el-row>
        ...
        <el-tab-pane key="6">
          ...
          <div class="tabBody">
            <el-radio-group v-model="result.year.cronEvery">
              ...
              <el-row>
                <el-radio class="long" label="3">具体年份(可多选)</el-radio>
                <el-select style="width:354px;" size="small" filterable multiple    v-model="result.year.specificSpecific">
                  <el-option v-for="(val,index) in Array(100)" :key="index" :label="2019+index" :value="2019+index">{{ 2019+index }}</el-option>
                </el-select>
              </el-row>
              <el-row>
                <el-radio label="4">从
