<template>
  <div class="user-container">
    ...
    <!-- 查询部分  -->
  <YyptQuery :querycols="querycolumn" @query="query" ref="yyptquery"></YyptQuery>
          ...
          <el-row>
           <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
              <el-form-item prop="tenantId" label= "租户ID">
                    <el-select v-model="user.tenantId" clearable placeholder="请选择">
                      <el-option
...
const querycolumn = [
  ...
  export default {
    ...
    methods: {
      ...
      getTenants(){
        this.$api.post('/system/sys-tenant/all',{}).then( resp =>
